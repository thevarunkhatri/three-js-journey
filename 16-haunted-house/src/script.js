...
bush1.position.set(1.2, 0.2, 2)

const bush2 = new THREE.Mesh(bushGeometry, bushMaterial)
bush2.scale.set(0.3, 0.3, 0.3)
bush2.position.set(1.8, 0.1, 2.2)
...
bush4.position.set(-1.9, 0.2, 2.5)
...
for(let i = 0; i < 50; i++) {
    ...
    grave.position.set(x, grave.geometry.parameters.height * 0.4, z)
